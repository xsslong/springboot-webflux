...
import io.github.helloworlde.mysql.MySQLApplicationTests;
...
public class PostControllerTest extends MySQLApplicationTests {
    ...
    private URI saveAndValidatePost(String title, String content) {
        ...
        final Long[] postIdArr = new Long[1];
        postResult.getResponseBody().subscribe(post -> postIdArr[0] = post.getId());

        return URI.create(POST_URI.concat("/").concat(String.valueOf(postIdArr[0])));
    }
